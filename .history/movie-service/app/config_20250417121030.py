...
CAST_SERVICE_HOST_URL = os.getenv('CAST_SERVICE_HOST_URL', 'http://localhost:8002/api/v1/casts/')
CAST_SERVICE_WS_URL = os.getenv('CAST_SERVICE_WS_URL', 'ws://localhost:8002/api/v1/casts/ws/cast-info')
